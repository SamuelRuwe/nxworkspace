...
export default {
  title: 'Tables/Bases/Expandable Table Base',
...
export const Primary = () => ({
  ...
  template: `<pg-layout-expandable-table-base
        [elementData]="data"
        [columns]="columns"
        [expandedRowGenerator]="expandedRowGenerator"></pg-layout-expandable-table-base>`
});
