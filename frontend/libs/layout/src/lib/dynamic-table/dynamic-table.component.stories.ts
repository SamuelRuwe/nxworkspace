...
import { stringCell } from '../cell/cell';
...
const columns = [
  {columnDef: 'position', header: 'No.', cell: (ele: any) => stringCell({value: ele.position})},
  {columnDef: 'name', header: 'Name', cell: (ele: any) => stringCell({value: ele.name})},
  {columnDef: 'weight', header: 'Weight', cell: (ele: any) => stringCell({value: ele.weight})},
  {columnDef: 'symbol', header: 'Symbol', cell: (ele: any) => stringCell({value: ele.symbol + ' days'})}
