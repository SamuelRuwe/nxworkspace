...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_olc_OnPageUnload')) {
        Object.defineProperty(Module['ready'], '_olc_OnPageUnload', { configurable: true, get: function() { abort('You are getting _olc_OnPageUnload on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_olc_OnPageUnload', { configurable: true, set: function() { abort('You are setting _olc_OnPageUnload on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }


      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_olc_PGE_UpdateWindowSize')) {
        Object.defineProperty(Module['ready'], '_olc_PGE_UpdateWindowSize', { configurable: true, get: function() { abort('You are getting _olc_PGE_UpdateWindowSize on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_olc_PGE_UpdateWindowSize', { configurable: true, set: function() { abort('You are setting _olc_PGE_UpdateWindowSize on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
