...
var asmLibraryArg = {"a": ___assert_fail, "b": _emscripten_resize_heap};
var asm = createWasm();
...
var _version = Module["_version"] = function () {
  return (_version = Module["_version"] = Module["asm"]["f"]).apply(null, arguments)
};
var _create_buffer = Module["_create_buffer"] = function () {
  return (_create_buffer = Module["_create_buffer"] = Module["asm"]["g"]).apply(null, arguments)
};
var _destroy_buffer = Module["_destroy_buffer"] = function () {
  return (_destroy_buffer = Module["_destroy_buffer"] = Module["asm"]["h"]).apply(null, arguments)
};
var _encode = Module["_encode"] = function () {
  return (_encode = Module["_encode"] = Module["asm"]["i"]).apply(null, arguments)
};
var _free_result = Module["_free_result"] = function () {
  return (_free_result = Module["_free_result"] = Module["asm"]["j"]).apply(null, arguments)
};
var _get_result_pointer = Module["_get_result_pointer"] = function () {
  return (_get_result_pointer = Module["_get_result_pointer"] = Module["asm"]["k"]).apply(null, arguments)
};
